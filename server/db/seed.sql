...
VALUES
    (1, 'To Kill a Mockingbird', 1, 'Harper Lee', 'Shoot all the blue jays you want if you can hit ''em, but remember it''s a sin to kill a mockingbird.'''),
    (2, '1984', 1, 'George Orwell', 'When you put in words it sounded reasonable: it was when you looked at the human beings passing you on the pavement that it became an act of faith.'),
    ...
    (4, 'The Hunger Games', 1, 'Suzanne Collins', 'The agony of kissing Gale so hard returns to me, and I think, why did I do that? Because I couldn''t help myself. Gale''s mine. I''m his.'),
    (5, 'Harry Potter and the Philosopher''s Stone', 1, 'J.K. Rowling', 'He sat up and clutched the package to his chest. ''I''m going to have a lot of fun with Dudley this summer,'' he grinned maliciously.'),
    ...
    (9, 'The Lord of the Rings', 1, 'J.R.R. Tolkien', 'The world is not in your books and maps; it is made up of living people, who lived and died in places forgotten now.')
...
VALUES
    ...
    (1003, 'Don''t Stop Believin''', 2, 'Journey', 'Just a city boy, born and raised in South Detroit. He took the midnight train going anywhere.'),
